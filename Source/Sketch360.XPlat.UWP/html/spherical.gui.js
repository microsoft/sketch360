...
var sphericalGui = (function () {

    var _isVrCamera = false;
    var _vrCamera = null;
    var _camera = null;

    var addUI = function(scene, camera) {
        _vrCamera = scene.activeCamera;
        _camera = camera;
        ...
        button.onPointerClickObservable.add(function (value) {
            if (_isVrCamera) {
                ...
                scene.activeCamera = _vrCamera;
                panel.background = "black";
            }
            _isVrCamera = !_isVrCamera;

            resetPointerDownCount();
        });
    ...
    return {
        addSphericalPanningCameraToScene: addSphericalPanningCameraToScene,
        addUI: addUI
    };
